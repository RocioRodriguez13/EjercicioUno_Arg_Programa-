...
//            if (contador % 2 == 0) { 
//                System.out.println("Es par: "+ contador);
//            } else { System.out.println("Es impar: " + contador);
//            }}
////
//////D.
////
...
//////
////    for (numeroFin = 14; numeroFin >= contador; numeroFin --) {
////            if (numeroFin % 2 == 0)
////                System.out.println("Los numeros pares son: " + numeroFin);
////     
////     }
...
System.out.println("Categoría B");
 ...
 System.out.println("Categoría C");
                ...
                System.out.println("Categoría C");
                } else if((ingresos <= 1943273.04) && (superficie <= 85) &&
                (energia <= 100000)) {
                System.out.println("Categoría D");
                }else if((ingresos <= 2277684) && (superficie <= 110) &&
                (energia <= 130000) ) {
